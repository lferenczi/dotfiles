...
echo ""
echo "##############################################" $red
echo "#   CAUTION: DO NOT BLINDLY RUN THIS SCRIPT" $red
echo "#      YOU WILL PROBABLY REGRET IT..." $red
echo "#############################################" $red
echo ""
...
echo ""
echo "Display will sleep after 5 minutes, computer won't sleep"
systemsetup -setdisplaysleep 5 > /dev/null
systemsetup -setharddisksleep 5 > /dev/null
